        ...
        switch(actions){
          case 1:{ //add a student to a university
            ...
            if(university_index == -1)
            {
            	...
            	university_index = number_of_university - 1;
	            
		        }
          	if(input == 1 || input == 2)
            {
              list_of_university[university_index]->add_student(input);
            }
            else
		        {
      		  ...
      		  if(number_of_university >= 1)
            {
              if(status < 1 || status > number_of_university)
	        		...
	        		else	
	        		{
	        			...
	        			{
	        				list_of_university[status-1]->display_students(0, 0);        				
	        			}
	        			else
	        			{
	    					cout<<endl;
            ...
            if(number_of_university >= 1)
            {
                ...
                else  
                {
                    if(list_of_university[status - 1]->get_total_number_of_student() >= 1)
                    {
			                  ...
			                  if(input == 1)
			                  {
			                  	if(!list_of_university[status-1]->delete_student(name_to_delete, 1))
			                    {
			                        cout<<endl;
			                        cout<<endl;
			                  ...
			                  {
			                  	if(!list_of_university[status-1]->delete_student(name_to_delete, 2))
			                    {
			                        cout<<endl;
			                        cout<<endl;
          ...
          case 4:{ //display all students from all universities
          	if(number_of_university >= 1)
          	{
          	  int total_num_of_student = 0;
	          	for(int i = 0; i < number_of_university; i++)
	          	{
	          		if(list_of_university[i]->get_total_number_of_student() > 0)
	          		{
	          			list_of_university[i]->display_students(0, 0);
	          			total_num_of_student += list_of_university[i]->get_total_number_of_student();
	          		}
	          	}
      		  ...
      		  if(number_of_university >= 1)
            {
              if(status < 1 || status > number_of_university)
        		...
        		else	
        		{
        			...
        			{
        				list_of_university[status-1]->display_students(0, 1);
        			}
        			else
        			{
    					cout<<endl;
      		  ...
      		  if(number_of_university >= 1)
            {
              if(status < 1 || status > number_of_university)
	        		...
	        		else	
	        		{
	        			...
	        			{
	        				list_of_university[status-1]->display_students(0, 2);
	        			}
	        			else
	        			{
	    					cout<<endl;
